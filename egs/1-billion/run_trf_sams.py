...
def main():
    ...
    for tsize in [2]:
        ...
        read_model = workdir + 'trf_c{}_{}'.format(class_num, feat[0:-3])
        write_model = workdir + 'trf_c{}_{}.sams'.format(class_num, feat[0:-3])
        ...
        if '-train' in sys.argv or '-all' in sys.argv:
            ...
            config += ' -gamma-lambda {} -gamma-zeta {} -unupdate-lambda '.format(gamma_lambda, gamma_zeta)
